...
#
# Algorythm: Program will give user a math quiz with 10 random questions and will return their the grades
#
...
#    user_input = str(input())
#breaking the loop if user enter stop    
#    if user_input == 'stop':
#        break
#
#`
